"""Relevance Results page — LLM-justified keywords with is_relevant indicators."""
...
def render():
    ...
    with st.spinner("Loading relevance results…"):
    ...
    if items:
        ...
        st.info("No relevance results found yet. LLM processing may still be running.")
